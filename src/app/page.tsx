      ...
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        <div className="flex items-center justify-between">
            ...
            <div className="flex gap-x-1 pt-1 font-mono text-sm text-muted-foreground print:hidden">
              ...
              {RESUME_DATA.contact.tutoring ? (
                <Button
                  ...
                  asChild
                >
                  <a href={RESUME_DATA.contact.tutoring.url}>
          ...
          <Avatar className="size-40">
            <AvatarImage alt={RESUME_DATA.name} src={RESUME_DATA.avatarUrl} style={{ borderRadius: "20%" }}/>
        ...
        <Section>
          ...
          {RESUME_DATA.additional.map((work) => {
            return (
              <Card key={work.company}>
                <CardHeader>
                  <div className="flex items-center justify-between gap-x-2 text-base">
        ...
        <Section className="scroll-mb-16">
          <h2 className="text-xl font-bold">Recent Honors & Awards</h2>
          <div className="-mx-3 grid grid-cols-1 gap-3 print:grid-cols-3 print:gap-2 md:grid-cols-2 lg:grid-cols-3">
            {RESUME_DATA.honors.map((paper) => {
              return (
                <AwardCard
                  key={paper.title}
                  title={paper.title}
